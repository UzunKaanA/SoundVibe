...
//Main page, UIController, showing newReleases, featuredPlaylists, recommendedTracks
class HomeViewController: UIViewController {
  ...
  //cells that contains the things "featuredPlaylists vs."
  ...
  private func fetchData(){
    ...
    APICaller.shared.getRecommendedGenres { result in
      ...
      case .failure(_): break // (let error)
      }
    }
...
//    default:
//      cell.backgroundColor = .clear // Set a default color if needed
//    }
//    return cell
  }
